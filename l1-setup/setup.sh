...
anvil --port 8545 --chain-id 9 --dump-state "state/$PROTOCOL_VERSION-l1-state.json" &
...
OPERATOR_ACCOUNT="$(yq -r '.operator.address' "$WALLETS_PATH")"
