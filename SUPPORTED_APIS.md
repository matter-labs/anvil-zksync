...
| `ETH` | `eth_chainId` | NOT IMPLEMENTED | Returns the currently configured chain id |
...
| `ETH` | `eth_getTransactionByHash` | NOT IMPLEMENTED | Returns the information about a transaction requested by transaction hash |
