...
use zksync_types::{
    ...
    ECRECOVER_PRECOMPILE_ADDRESS, EC_PAIRING_PRECOMPILE_ADDRESS, EVENT_WRITER_ADDRESS,
...
pub const ROLLUP_L2_DA_VALIDATOR_ADDRESS: Address = H160([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x80, 0x80, 0x13,
]);
...
pub static COMPILED_IN_SYSTEM_CONTRACTS: Lazy<Vec<DeployedContract>> = Lazy::new(|| {
    let mut deployed_system_contracts = [
        ...
        (
            "RollupL2DAValidator",
            ROLLUP_L2_DA_VALIDATOR_ADDRESS,
            include_bytes!("contracts/RollupL2DAValidator.json").to_vec(),
        ),
        //
