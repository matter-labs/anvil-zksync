...
use zksync_types::{
    ...
    L2_BRIDGEHUB_ADDRESS, L2_GENESIS_UPGRADE_ADDRESS, L2_INTEROP_CENTER_ADDRESS, 
    L2_INTEROP_HANDLER_ADDRESS, L2_INTEROP_ROOT_STORAGE_ADDRESS, L2_MESSAGE_ROOT_ADDRESS,
    L2_MESSAGE_VERIFICATION_ADDRESS, L2_NATIVE_TOKEN_VAULT_ADDRESS, L2_STANDARD_TRIGGER_ACCOUNT_ADDRESS, 
    L2_WRAPPED_BASE_TOKEN_IMPL, INTEROP_ACCOUNT_ADDRESS, MODEXP_PRECOMPILE_ADDRESS, 
...
static BUILTIN_CONTRACT_LOCATIONS: [(&str, Address, ProtocolVersionId); 45] = [
    ...
    ("StandardTriggerAccount", L2_STANDARD_TRIGGER_ACCOUNT_ADDRESS, V30),
    (
        "AssetTracker",
