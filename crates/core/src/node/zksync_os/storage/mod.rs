use super::execution::metrics::STORAGE_VIEW_METRICS;
use super::tx_conversions::transaction_to_api_data;
use super::util::bytes32_to_address;
use super::zkos_conversions::h256_to_bytes32;
use super::{CHAIN_ID, STATE_STORAGE_PATH};
use dashmap::DashMap;
use in_memory_account_properties::InMemoryAccountProperties;
use in_memory_block_receipts::InMemoryBlockReceipts;
use in_memory_preimages::InMemoryPreimages;
use in_memory_tx_receipts::InMemoryTxReceipts;
use itertools::Either;
use persistent_storage_map::{PersistentStorageMap, StorageMapCF};
use rocksdb_preimages::{PreimagesCF, RocksDbPreimages};
use std::collections::HashMap;
use std::path::Path;
use std::sync::atomic::{AtomicU64, Ordering};
use std::sync::Arc;
use std::time::Instant;
use storage_map::{Diff, StorageMap, StorageMapView};
use storage_metrics::StorageMetrics;
...
impl StateHandle {
    ...
    pub async fn collect_state_metrics(&self) {
