...
pub mod anvil_zks {
    ...
    pub mod halt {
        ...
        #[macro_export]
        macro_rules ! anvil_zks_halt_generic_error { ($ ($ arg : tt) *) => { zksync_error :: anvil_zks :: halt :: HaltError :: GenericError { message : format ! ($ ($ arg) *) } } ; }
        pub use crate::anvil_zks_halt_generic_error as generic_error;
        ...
        pub fn to_domain<T: std::fmt::Display>(err: T) -> super::AnvilZKSError {
            super::AnvilZKSError::Halt(GenericError {
                message: err.to_string(),
            })
        }
    }
    pub mod revert {
        ...
        #[macro_export]
        macro_rules ! anvil_zks_revert_generic_error { ($ ($ arg : tt) *) => { zksync_error :: anvil_zks :: revert :: RevertError :: GenericError { message : format ! ($ ($ arg) *) } } ; }
        pub use crate::anvil_zks_revert_generic_error as generic_error;
        ...
        pub fn to_domain<T: std::fmt::Display>(err: T) -> super::AnvilZKSError {
            super::AnvilZKSError::Revert(GenericError {
                message: err.to_string(),
            })
        }
    }
