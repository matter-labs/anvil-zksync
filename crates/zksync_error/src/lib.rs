...
pub mod anvil {
    pub mod halt {
        ...
        #[macro_export]
        macro_rules ! anvil_halt_generic_error { ($ ($ arg : tt) *) => { zksync_error :: error :: definitions :: Halt :: GenericError { message : format ! ($ ($ arg) *) } } ; }
    ...
    pub mod revert {
        ...
        #[macro_export]
        macro_rules ! anvil_revert_generic_error { ($ ($ arg : tt) *) => { zksync_error :: error :: definitions :: Revert :: GenericError { message : format ! ($ ($ arg) *) } } ; }
