...
impl Identifier {
    ...
    pub fn decode(code: StructuredErrorCode) -> Option<Self> {
        ...
        let kind: Kind = match domain {
         ...
         DomainCode::Anvil => {
            Kind::Anvil(AnvilCode::from_repr(component_code)?)
         },
         DomainCode::Compiler => {
            Kind::Compiler(CompilerCode::from_repr(component_code)?)
         },
         DomainCode::Core => {
            Kind::Core(CoreCode::from_repr(component_code)?)
         },
         DomainCode::Foundry => {
            Kind::Foundry(FoundryCode::from_repr(component_code)?)
         },
         DomainCode::Hardhat => {
            Kind::Hardhat(HardhatCode::from_repr(component_code)?)
         },
...
impl NamedError for Identifier {
    fn get_error_name(&self) -> String {
        match self.kind {
         ...
         Kind::Foundry(FoundryCode::FoundryUpstream) => crate::error::definitions::FoundryUpstreamCode::from_repr(self.code).expect("Internal error").get_error_name(),
         ...
         Kind::Hardhat(HardhatCode::HardhatUpstream) => crate::error::definitions::HardhatUpstreamCode::from_repr(self.code).expect("Internal error").get_error_name(),
         Kind::Hardhat(HardhatCode::HardhatZksync) => crate::error::definitions::HardhatZksyncCode::from_repr(self.code).expect("Internal error").get_error_name(),
