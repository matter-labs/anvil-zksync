...
use crate::error::domains::AnvilZKSCode;
...
impl Identifier {
    ...
    pub fn decode(code: StructuredErrorCode) -> Option<Self> {
        ...
        let kind: Kind = match domain {
            DomainCode::AnvilZKS => Kind::AnvilZKS(AnvilZKSCode::from_repr(component_code)?),
    ...
    fn get_error_name(&self) -> String {
        match self.kind {
            Kind::AnvilZKS(AnvilZKSCode::AnvilZKSEnvironment) => {
                crate::error::definitions::AnvilZKSEnvironmentCode::from_repr(self.code)
