---
title: fork
description: Start a local chain that is a fork of another network
layout: docs
showOutline: 2
---
...
- [`run`](/cli/run) — start a clean chain
- [`replay_tx`](/cli/replay_tx) — fork & replay a specific transaction
- [`CLI Overview`](/cli/) — global flags and usage
