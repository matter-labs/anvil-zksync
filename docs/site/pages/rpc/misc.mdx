---
title: Miscellaneous RPC
description: EVM, Network, Web3, and Debug namespaces
layout: docs
showOutline: 2
---
...
Use them alongside the core [`eth_*`](/rpc/eth) and [`zks_*`](/rpc/zks) calls for full
functionality.
...
- [`hardhat_*`](/rpc/hardhat) — Hardhat style helpers
