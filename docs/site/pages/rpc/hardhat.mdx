---
title: hardhat_ RPC
description: Hardhat‑style JSON‑RPC helpers for state‑modifying tests
layout: docs
showOutline: 2
---
...
Utility methods that mimic **Hardhat Network** behaviour (impersonation, snapshot resets, on demand
mining, etc.).  
...
- [`anvil_*`](/rpc/anvil) — node management helpers
