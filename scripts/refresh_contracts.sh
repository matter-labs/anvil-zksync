...
# Copy JSON ABI files `<contract_name>.json` for L2 contracts that are identical to their L1 counterparts from SRC to DST
...
l2_contracts=("TimestampAsserter" "RollupL2DAValidator")
